...
import br.edu.Tads.TrabalhoFinalLTPIII.DataAccess.CargoDAO;
 ...
 * @author Jessica
 */
public class frmCargoListagem extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form frmCargoListagem
     */
    public frmCargoListagem() {
        initComponents();
        ...
        preencheTabela(cargos);
        
    }
    
    private void preencheTabela(List<Cargo> lista) {
    ...
    private void tblListagemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListagemMouseClicked
        ...
        Cargo c = DAO.AbrirCargo((int) valor);
        frmCargoEditar janela = new frmCargoEditar(c, DAO);
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        ...
        frmCargoEditar janela = new frmCargoEditar(c, d);
        this.getParent().add(janela);
        janela.setVisible(true);
        this.setVisible(false);
